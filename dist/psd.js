...
var polyfills = __webpack_require__(/*! ./polyfills.js */ 51)
var legacy = __webpack_require__(/*! ./legacy-streams.js */ 53)
var queue = []
...
if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
  process.on('exit', function() {
    debug(queue)
    __webpack_require__(/*! assert */ 23).equal(queue.length, 0)
  })
}

module.exports = patch(__webpack_require__(/*! ./fs.js */ 22))
...
const u = __webpack_require__(/*! universalify */ 2).fromCallback
const mkdirs = u(__webpack_require__(/*! ./mkdirs */ 56))
const mkdirsSync = __webpack_require__(/*! ./mkdirs-sync */ 57)
...
const u = __webpack_require__(/*! universalify */ 2).fromPromise
const fs = __webpack_require__(/*! ../fs */ 21)
...
const u = __webpack_require__(/*! universalify */ 2).fromCallback
const rimraf = __webpack_require__(/*! ./rimraf */ 61)
...
const u = __webpack_require__(/*! universalify */ 2).fromCallback
const jsonFile = __webpack_require__(/*! jsonfile */ 69)
...
var _flatten2 = __webpack_require__(/*! lodash/flatten */ 107);
...
class Node {
  ...
  descendants() {
    return (0, _flatten3.default)(this._children.map(n => n.subtree()));
  }
  ...
  childrenAtPath(path, caseSensitive = true) {
    ...
    return (0, _flatten3.default)(matches.map(m => m.childrenAtPath(path, caseSensitive)));
  }
}
...
var root = __webpack_require__(/*! ./_root */ 111);
...
var bomHandling = __webpack_require__(/*! ./bom-handling */ 33),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(/*! ../encodings */ 34); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(/*! ./streams */ 49)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(/*! ./extend-node */ 50)(iconv);
}
...
module.exports = Object.assign(
  ...
  __webpack_require__(/*! ./copy-sync */ 24),
  __webpack_require__(/*! ./copy */ 28),
  __webpack_require__(/*! ./empty */ 60),
  __webpack_require__(/*! ./ensure */ 62),
  __webpack_require__(/*! ./json */ 68),
  __webpack_require__(/*! ./mkdirs */ 3),
  __webpack_require__(/*! ./move-sync */ 72),
  __webpack_require__(/*! ./move */ 73),
  __webpack_require__(/*! ./output */ 74),
  __webpack_require__(/*! ./path-exists */ 5),
  __webpack_require__(/*! ./remove */ 10)
)
...
const u = __webpack_require__(/*! universalify */ 2).fromCallback
const fs = __webpack_require__(/*! graceful-fs */ 1)
...
module.exports = {
  copySync: __webpack_require__(/*! ./copy-sync */ 55)
}
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const os = __webpack_require__(/*! os */ 58)
const path = __webpack_require__(/*! path */ 0)
...
const u = __webpack_require__(/*! universalify */ 2).fromCallback
module.exports = {
  copy: u(__webpack_require__(/*! ./copy */ 59))
}
...
var _file = __webpack_require__(/*! ./psd/file */ 31);

var _file2 = _interopRequireDefault(_file);

var _lazy_execute = __webpack_require__(/*! ./psd/lazy_execute */ 13);

var _lazy_execute2 = _interopRequireDefault(_lazy_execute);

var _header = __webpack_require__(/*! ./psd/header */ 75);

var _header2 = _interopRequireDefault(_header);

var _resources = __webpack_require__(/*! ./psd/resources */ 76);

var _resources2 = _interopRequireDefault(_resources);

var _layer_mask = __webpack_require__(/*! ./psd/layer_mask */ 79);

var _layer_mask2 = _interopRequireDefault(_layer_mask);

var _image = __webpack_require__(/*! ./psd/image */ 99);

var _image2 = _interopRequireDefault(_image);

var _root = __webpack_require__(/*! ./psd/nodes/root */ 106);

var _root2 = _interopRequireDefault(_root);

var _artboards = __webpack_require__(/*! ./psd/artboards */ 121);
...
var _jspack = __webpack_require__(/*! jspack */ 32);

var _iconvLite = __webpack_require__(/*! iconv-lite */ 17);

var _iconvLite2 = _interopRequireDefault(_iconvLite);

var _fsExtra = __webpack_require__(/*! fs-extra */ 20);
...
Object.defineProperty(File, 'MAX_CHUNK_SIZE', {
  enumerable: true,
  writable: true,
  value: 10000000
});
...
var modules = [
    __webpack_require__(/*! ./internal */ 35),
    __webpack_require__(/*! ./utf16 */ 37),
    __webpack_require__(/*! ./utf7 */ 38),
    __webpack_require__(/*! ./sbcs-codec */ 39),
    __webpack_require__(/*! ./sbcs-data */ 40),
    __webpack_require__(/*! ./sbcs-data-generated */ 41),
    __webpack_require__(/*! ./dbcs-codec */ 42),
    __webpack_require__(/*! ./dbcs-data */ 43),
];
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/shiftjis.json */ 44) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/eucjp.json */ 45) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp936.json */ 11) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp936.json */ 11).concat(__webpack_require__(/*! ./tables/gbk-added.json */ 18)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp936.json */ 11).concat(__webpack_require__(/*! ./tables/gbk-added.json */ 18)) },
        gb18030: function() { return __webpack_require__(/*! ./tables/gb18030-ranges.json */ 46) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp949.json */ 47) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp950.json */ 19) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp950.json */ 19).concat(__webpack_require__(/*! ./tables/big5-added.json */ 48)) },
...
var Buffer = __webpack_require__(/*! buffer */ 4).Buffer,
    Transform = __webpack_require__(/*! stream */ 7).Transform;
...
module.exports = function (iconv) {
    ...
    iconv.extendNodeEncodings = function extendNodeEncodings() {
        ...
        // -- SlowBuffer -----------------------------------------------------------
        var SlowBuffer = __webpack_require__(/*! buffer */ 4).SlowBuffer;
...
var fs = __webpack_require__(/*! ./fs.js */ 22)
...
var Stream = __webpack_require__(/*! stream */ 7).Stream
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const path = __webpack_require__(/*! path */ 0)
const mkdirpSync = __webpack_require__(/*! ../mkdirs */ 3).mkdirsSync
const utimesSync = __webpack_require__(/*! ../util/utimes.js */ 26).utimesMillisSync
...
function copyFileFallback (srcStat, src, dest, opts) {
  ...
  const _buff = __webpack_require__(/*! ../util/buffer */ 27)(BUF_LENGTH)
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const path = __webpack_require__(/*! path */ 0)
const invalidWin32Path = __webpack_require__(/*! ./win32 */ 25).invalidWin32Path
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const path = __webpack_require__(/*! path */ 0)
const mkdirp = __webpack_require__(/*! ../mkdirs */ 3).mkdirs
const pathExists = __webpack_require__(/*! ../path-exists */ 5).pathExists
const utimes = __webpack_require__(/*! ../util/utimes */ 26).utimesMillis
...
const fs = __webpack_require__(/*! fs */ 8)
const path = __webpack_require__(/*! path */ 0)
const mkdir = __webpack_require__(/*! ../mkdirs */ 3)
const remove = __webpack_require__(/*! ../remove */ 10)
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const path = __webpack_require__(/*! path */ 0)
const assert = __webpack_require__(/*! assert */ 23)
...
const file = __webpack_require__(/*! ./file */ 63)
const link = __webpack_require__(/*! ./link */ 64)
const symlink = __webpack_require__(/*! ./symlink */ 65)
...
const path = __webpack_require__(/*! path */ 0)
const fs = __webpack_require__(/*! graceful-fs */ 1)
const _mkdirs = __webpack_require__(/*! ../mkdirs */ 3)
const mkdirs = _mkdirs.mkdirs
const mkdirsSync = _mkdirs.mkdirsSync

const _symlinkPaths = __webpack_require__(/*! ./symlink-paths */ 66)
const symlinkPaths = _symlinkPaths.symlinkPaths
const symlinkPathsSync = _symlinkPaths.symlinkPathsSync

const _symlinkType = __webpack_require__(/*! ./symlink-type */ 67)
...
const u = __webpack_require__(/*! universalify */ 2).fromCallback
const jsonFile = __webpack_require__(/*! ./jsonfile */ 12)

jsonFile.outputJson = u(__webpack_require__(/*! ./output-json */ 70))
jsonFile.outputJsonSync = __webpack_require__(/*! ./output-json-sync */ 71)
// aliases
...
var _fs
try {
  _fs = __webpack_require__(/*! graceful-fs */ 1)
} catch (_) {
  _fs = __webpack_require__(/*! fs */ 8)
}
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const path = __webpack_require__(/*! path */ 0)
const copySync = __webpack_require__(/*! ../copy-sync */ 24).copySync
const removeSync = __webpack_require__(/*! ../remove */ 10).removeSync
const mkdirpSync = __webpack_require__(/*! ../mkdirs */ 3).mkdirsSync
const buffer = __webpack_require__(/*! ../util/buffer */ 27)
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const path = __webpack_require__(/*! path */ 0)
const copy = __webpack_require__(/*! ../copy */ 28).copy
const remove = __webpack_require__(/*! ../remove */ 10).remove
const mkdirp = __webpack_require__(/*! ../mkdirs */ 3).mkdirp
const pathExists = __webpack_require__(/*! ../path-exists */ 5).pathExists
...
Object.defineProperty(Header, 'CHUNK_SIZE', {
  enumerable: true,
  writable: true,
  value: 10000
});
...
var _resource = __webpack_require__(/*! ./resource */ 77);
...
var _layer_comps = __webpack_require__(/*! ./resources/layer_comps */ 78);
...
/* 78 */
/*!******************************************!*\
  !*** ./src/psd/resources/layer_comps.js ***!
  \******************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _layer = __webpack_require__(/*! ./layer */ 80);
...
var _channel_image = __webpack_require__(/*! ./channel_image */ 81);

var _channel_image2 = _interopRequireDefault(_channel_image);

var _position_channels = __webpack_require__(/*! ./layer/position_channels */ 82);

var _position_channels2 = _interopRequireDefault(_position_channels);

var _blend_modes = __webpack_require__(/*! ./layer/blend_modes */ 83);

var _blend_modes2 = _interopRequireDefault(_blend_modes);

var _mask_data = __webpack_require__(/*! ./layer/mask_data */ 85);

var _mask_data2 = _interopRequireDefault(_mask_data);

var _blending_ranges = __webpack_require__(/*! ./layer/blending_ranges */ 87);

var _blending_ranges2 = _interopRequireDefault(_blending_ranges);

var _legacy_name = __webpack_require__(/*! ./layer/legacy_name */ 88);

var _legacy_name2 = _interopRequireDefault(_legacy_name);

var _info = __webpack_require__(/*! ./layer/info */ 89);
...
class Layer {
  ...
  constructor(file, header) {
    ...
    Object.defineProperty(this, 'availableInfoKeys', {
      enumerable: true,
      writable: true,
      value: []
    });
    Object.defineProperty(this, 'parsedInfoKeys', {
      enumerable: true,
      writable: true,
      value: []
    });
...
/* 82 */
/*!********************************************!*\
  !*** ./src/psd/layer/position_channels.js ***!
  \********************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _blend_mode = __webpack_require__(/*! ../blend_mode */ 84);
...
var _mask = __webpack_require__(/*! ../mask */ 86);
...
/* 87 */
/*!******************************************!*\
  !*** ./src/psd/layer/blending_ranges.js ***!
  \******************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _artboard = __webpack_require__(/*! ./info/artboard */ 90);

var _artboard2 = _interopRequireDefault(_artboard);

var _blend_clipping_elements = __webpack_require__(/*! ./info/blend_clipping_elements */ 91);

var _blend_clipping_elements2 = _interopRequireDefault(_blend_clipping_elements);

var _blend_interior_elements = __webpack_require__(/*! ./info/blend_interior_elements */ 92);

var _blend_interior_elements2 = _interopRequireDefault(_blend_interior_elements);

var _layer_id = __webpack_require__(/*! ./info/layer_id */ 93);

var _layer_id2 = _interopRequireDefault(_layer_id);

var _nested_section_divider = __webpack_require__(/*! ./info/nested_section_divider */ 94);

var _nested_section_divider2 = _interopRequireDefault(_nested_section_divider);

var _section_divider = __webpack_require__(/*! ./info/section_divider */ 95);

var _section_divider2 = _interopRequireDefault(_section_divider);

var _typetool = __webpack_require__(/*! ./info/typetool */ 96);

var _typetool2 = _interopRequireDefault(_typetool);

var _unicode_name = __webpack_require__(/*! ./info/unicode_name */ 98);
...
function parseLayerInfo(layer) {
  ...
  while (file.tell() < layer.layerEnd) {
    ...
    for (var i = 0; i < LAYER_INFO.length; i++) {
      ...
      layer.adjustments[infoClass.name] = new _lazy_execute2.default(info, file).now('skip').later('parse').get();
...
/* 90 */
/*!****************************************!*\
  !*** ./src/psd/layer/info/artboard.js ***!
  \****************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
/* 91 */
/*!*******************************************************!*\
  !*** ./src/psd/layer/info/blend_clipping_elements.js ***!
  \*******************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
/* 92 */
/*!*******************************************************!*\
  !*** ./src/psd/layer/info/blend_interior_elements.js ***!
  \*******************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _parseEngineData = __webpack_require__(/*! parse-engine-data */ 97);
...
var iconv = __webpack_require__(/*! iconv-lite */ 17)
...
var _rgb = __webpack_require__(/*! ./image/mode/rgb */ 100);

var _cmyk = __webpack_require__(/*! ./image/mode/cmyk */ 101);

var _greyscale = __webpack_require__(/*! ./image/mode/greyscale */ 103);

var _raw = __webpack_require__(/*! ./image/format/raw */ 104);

var _rle = __webpack_require__(/*! ./image/format/rle */ 105);
...
class Image {
  ...
  constructor(file, header) {
    ...
    Object.defineProperty(this, 'hasMask', {
      enumerable: true,
      writable: true,
      value: false
    });
...
function setRgbChannels(image) {
  image.channelsInfo = [{ id: 0 }, { id: 1 }, { id: 2 }];
...
exports.setRgbChannels = setRgbChannels;
...
var _color = __webpack_require__(/*! ../../color */ 102);
...
exports.setCmykChannels = setCmykChannels;
...
exports.setGreyscaleChannels = setGreyscaleChannels;
...
class RLECompression {
  ...
  constructor(image) {
    ...
    Object.defineProperty(this, 'chanPos', {
      enumerable: true,
      writable: true,
      value: 0
    });
    Object.defineProperty(this, 'lineIndex', {
      enumerable: true,
      writable: true,
      value: 0
    });
...
var _group = __webpack_require__(/*! ./group */ 119);

var _group2 = _interopRequireDefault(_group);

var _layer = __webpack_require__(/*! ./layer */ 120);
  ...
  constructor(psd) {
    ...
    for (var i = 0; i < this.psd.layerMask.layers.length; i++) {
      ...
      if (layer.isFolder()) {
        ...
        currentGroup = new _group2.default(layer, parseStack[parseStack.length - 1]);
      } else if (layer.isFolderEnd()) {
        parent = parseStack.pop();
        parent.children().push(currentGroup);
        currentGroup = parent;
      } else {
        currentGroup.children().push(new _layer2.default(layer, currentGroup));
      }
    }
...
var baseFlatten = __webpack_require__(/*! ./_baseFlatten */ 108);
...
var arrayPush = __webpack_require__(/*! ./_arrayPush */ 109),
    isFlattenable = __webpack_require__(/*! ./_isFlattenable */ 110);
...
var Symbol = __webpack_require__(/*! ./_Symbol */ 16),
    isArguments = __webpack_require__(/*! ./isArguments */ 113),
    isArray = __webpack_require__(/*! ./isArray */ 118);
...
var freeGlobal = __webpack_require__(/*! ./_freeGlobal */ 112);
...
var baseIsArguments = __webpack_require__(/*! ./_baseIsArguments */ 114),
...
var Symbol = __webpack_require__(/*! ./_Symbol */ 16),
    getRawTag = __webpack_require__(/*! ./_getRawTag */ 116),
    objectToString = __webpack_require__(/*! ./_objectToString */ 117);
