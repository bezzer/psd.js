...
var polyfills = __webpack_require__(/*! ./polyfills.js */ 49)
var legacy = __webpack_require__(/*! ./legacy-streams.js */ 51)
var queue = []
...
if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
  process.on('exit', function() {
    debug(queue)
    __webpack_require__(/*! assert */ 22).equal(queue.length, 0)
  })
}
...
const mkdirs = u(__webpack_require__(/*! ./mkdirs */ 54))
const mkdirsSync = __webpack_require__(/*! ./mkdirs-sync */ 55)
...
const fs = __webpack_require__(/*! ../fs */ 20)
...
const u = __webpack_require__(/*! universalify */ 2).fromCallback
const rimraf = __webpack_require__(/*! ./rimraf */ 59)
...
const u = __webpack_require__(/*! universalify */ 2).fromCallback
const jsonFile = __webpack_require__(/*! jsonfile */ 67)
...
var bomHandling = __webpack_require__(/*! ./bom-handling */ 31),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(/*! ../encodings */ 32); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(/*! ./streams */ 47)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(/*! ./extend-node */ 48)(iconv);
}
...
module.exports = Object.assign(
  ...
  __webpack_require__(/*! ./fs */ 20),
  // Export extra methods:
  __webpack_require__(/*! ./copy-sync */ 23),
  __webpack_require__(/*! ./copy */ 27),
  __webpack_require__(/*! ./empty */ 58),
  __webpack_require__(/*! ./ensure */ 60),
  __webpack_require__(/*! ./json */ 66),
  __webpack_require__(/*! ./mkdirs */ 3),
  __webpack_require__(/*! ./move-sync */ 70),
  __webpack_require__(/*! ./move */ 71),
  __webpack_require__(/*! ./output */ 72),
...
module.exports = {
  copySync: __webpack_require__(/*! ./copy-sync */ 53)
}
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const os = __webpack_require__(/*! os */ 56)
const path = __webpack_require__(/*! path */ 0)
...
const u = __webpack_require__(/*! universalify */ 2).fromCallback
module.exports = {
  copy: u(__webpack_require__(/*! ./copy */ 57))
}
...
var _header = __webpack_require__(/*! ./psd/header */ 73);

var _header2 = _interopRequireDefault(_header);

var _resources = __webpack_require__(/*! ./psd/resources */ 74);

var _resources2 = _interopRequireDefault(_resources);

var _layer_mask = __webpack_require__(/*! ./psd/layer_mask */ 77);
...
var modules = [
    __webpack_require__(/*! ./internal */ 33),
    __webpack_require__(/*! ./utf16 */ 35),
    __webpack_require__(/*! ./utf7 */ 36),
    __webpack_require__(/*! ./sbcs-codec */ 37),
    __webpack_require__(/*! ./sbcs-data */ 38),
    __webpack_require__(/*! ./sbcs-data-generated */ 39),
    __webpack_require__(/*! ./dbcs-codec */ 40),
    __webpack_require__(/*! ./dbcs-data */ 41),
];
...
var StringDecoder = __webpack_require__(/*! string_decoder */ 34).StringDecoder;
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/shiftjis.json */ 42) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/eucjp.json */ 43) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp936.json */ 11).concat(__webpack_require__(/*! ./tables/gbk-added.json */ 17)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp936.json */ 11).concat(__webpack_require__(/*! ./tables/gbk-added.json */ 17)) },
        gb18030: function() { return __webpack_require__(/*! ./tables/gb18030-ranges.json */ 44) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp949.json */ 45) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp950.json */ 18) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(/*! ./tables/cp950.json */ 18).concat(__webpack_require__(/*! ./tables/big5-added.json */ 46)) },
...
const utimesSync = __webpack_require__(/*! ../util/utimes.js */ 25).utimesMillisSync
...
function copyFileFallback (srcStat, src, dest, opts) {
  ...
  const _buff = __webpack_require__(/*! ../util/buffer */ 26)(BUF_LENGTH)
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const path = __webpack_require__(/*! path */ 0)
const invalidWin32Path = __webpack_require__(/*! ./win32 */ 24).invalidWin32Path
...
const utimes = __webpack_require__(/*! ../util/utimes */ 25).utimesMillis
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const path = __webpack_require__(/*! path */ 0)
const assert = __webpack_require__(/*! assert */ 22)
...
const file = __webpack_require__(/*! ./file */ 61)
const link = __webpack_require__(/*! ./link */ 62)
const symlink = __webpack_require__(/*! ./symlink */ 63)
...
const _symlinkPaths = __webpack_require__(/*! ./symlink-paths */ 64)
const symlinkPaths = _symlinkPaths.symlinkPaths
const symlinkPathsSync = _symlinkPaths.symlinkPathsSync

const _symlinkType = __webpack_require__(/*! ./symlink-type */ 65)
...
jsonFile.outputJson = u(__webpack_require__(/*! ./output-json */ 68))
jsonFile.outputJsonSync = __webpack_require__(/*! ./output-json-sync */ 69)
// aliases
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const path = __webpack_require__(/*! path */ 0)
const copySync = __webpack_require__(/*! ../copy-sync */ 23).copySync
const removeSync = __webpack_require__(/*! ../remove */ 10).removeSync
const mkdirpSync = __webpack_require__(/*! ../mkdirs */ 3).mkdirsSync
const buffer = __webpack_require__(/*! ../util/buffer */ 26)
...
const fs = __webpack_require__(/*! graceful-fs */ 1)
const path = __webpack_require__(/*! path */ 0)
const copy = __webpack_require__(/*! ../copy */ 27).copy
...
var _channel_image = __webpack_require__(/*! ./channel_image */ 79);

var _channel_image2 = _interopRequireDefault(_channel_image);

var _position_channels = __webpack_require__(/*! ./layer/position_channels */ 80);

var _position_channels2 = _interopRequireDefault(_position_channels);

var _blend_modes = __webpack_require__(/*! ./layer/blend_modes */ 81);

var _blend_modes2 = _interopRequireDefault(_blend_modes);

var _mask_data = __webpack_require__(/*! ./layer/mask_data */ 83);

var _mask_data2 = _interopRequireDefault(_mask_data);

var _blending_ranges = __webpack_require__(/*! ./layer/blending_ranges */ 85);

var _blending_ranges2 = _interopRequireDefault(_blending_ranges);

var _legacy_name = __webpack_require__(/*! ./layer/legacy_name */ 86);

var _legacy_name2 = _interopRequireDefault(_legacy_name);

var _info = __webpack_require__(/*! ./layer/info */ 87);
...
var _blend_mode = __webpack_require__(/*! ../blend_mode */ 82);
...
var _mask = __webpack_require__(/*! ../mask */ 84);
...
var _artboard = __webpack_require__(/*! ./info/artboard */ 88);

var _artboard2 = _interopRequireDefault(_artboard);

var _blend_clipping_elements = __webpack_require__(/*! ./info/blend_clipping_elements */ 89);

var _blend_clipping_elements2 = _interopRequireDefault(_blend_clipping_elements);

var _blend_interior_elements = __webpack_require__(/*! ./info/blend_interior_elements */ 90);
...
var iconv = __webpack_require__(/*! iconv-lite */ 16)
